########## Change Detection of the drought in southern part of Sweden 2018                     ##########
########## 1. NDVI Analysis                                                                    ##########
########## 2. Classification of two Sentinel2 Satellite Images with following change detection ##########
########## 3. Analysis and Comparison of MODIS NDVI Time Series, MODIS Precipitation data      ##########
##########    and MODIS Temperature data                                                       ##########
